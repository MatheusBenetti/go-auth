...
import (
	...
	"github.com/MatheusBenetti/go-auth/utils"
...
func Signup(c *gin.Context) {
	...
	hashedPassword, errHash := utils.GenerateHashPassword(user.Password)
	if errHash != nil {
	...
	c.JSON(http.StatusOK, gin.H{"success": "User created", "user": user})
}
